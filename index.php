          ...
          <div class="servicos-tabela">
            <div class="tabela">
              <div class="aos-item" data-aos="fade-right">
                <img src="img/servico-icon-01.svg" alt="Lista" class="img-tabela-oficial" />
              ...
              <div class="aos-item" data-aos="fade-left">
                <img src="img/servico-icon-02.svg" alt="Marketing" class="img-tabela-oficial" />
              ...
              <div class="aos-item" data-aos="fade-right">
                <img src="img/servico-icon-03.svg" alt="Estrelas" class="img-tabela-oficial" />
      ...
      <div class="site">
        <div class="clientes-cont">
          ...
          <div class="clientes clientesCarro">
            ...
            <div class="client">
              <img src="img/cliente-perfil-03.svg" class="cliente-perfil" alt="foto de perfil de um cliente do site" />
              <h3>Nome</h3>
              <p>
                A empresa de desenvolvimento de sites foi incrível em criar um
                site responsivo e de alta qualidade para a minha empresa.
            ...
            <div class="client">
              <img src="img/cliente-perfil-04.svg" class="cliente-perfil" alt="foto de perfil de um cliente do site" />
              <h3>Nome</h3>
              <p>
                A empresa de desenvolvimento de sites foi incrível em criar um
                site responsivo e de alta qualidade para a minha empresa.
